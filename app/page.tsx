  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center">
      <main className="flex-1 flex flex-col items-center justify-center py-20">
        ...
        {isConnected ? (
          <h2 className="text-2xl mb-4">You are connected to MongoDB</h2>
        ) : (
          <h2 className="text-2xl mb-4">
            You are NOT connected to MongoDB. Check the{" "}
            <code className="bg-gray-100 rounded-md px-2 py-1">README.md</code>{" "}
            for instructions.
          </h2>
        )}
        ...
        <p className="text-xl text-center mb-8">
          ...
          <code className="bg-gray-100 rounded-md px-2 py-1">app/page.tsx</code>
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl">
          ...
          >
            <h3 className="text-xl font-bold mb-2">Documentation &rarr;</h3>
            <p className="text-lg">
          ...
          <a
            ...
            className="border border-gray-300 rounded-lg p-6 hover:border-blue-600 hover:text-blue-600"
          >
            <h3 className="text-xl font-bold mb-2">Examples &rarr;</h3>
            <p className="text-lg">
          ...
          <a
            ...
            className="border border-gray-300 rounded-lg p-6 hover:border-blue-600 hover:text-blue-600"
          >
            <h3 className="text-xl font-bold mb-2">Deploy &rarr;</h3>
            <p className="text-lg">
